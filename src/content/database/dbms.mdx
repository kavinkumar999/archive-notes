...
![key functions](/archive-notes/png/database/fdbms.png)
...
![image](/archive-notes/png/database/er.png)
...
![image](/archive-notes/png/database/er-model.png)
...
### Attributes types
####  simple attribute
![image](/archive-notes/png/database/attribute.png)

#### Primary key attribute
![image](/archive-notes/png/database/pk-attribute.png)

#### Derived Attribute for any Entity

![image](/archive-notes/png/database/derived-att.png)


#### Multivalued Attribute for any Entity
![image](/archive-notes/png/database/multi-attr.png)

#### Composite Attribute for any Entity
![image](/archive-notes/png/database/compose-attr.png)
...
![image](/archive-notes/png/database/db-transaction.png)
