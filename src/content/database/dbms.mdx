...
![key functions](/png/database/fdbms.png)
...
![image](/png/database/er-model.png)
...
### Attributes types
####  simple attribute
![image](/png/database/attribute.png)

#### Primary key attribute
![image](/png/database/pk-attribute.png)

#### Derived Attribute for any Entity

![image](/png/database/derived-att.png)


#### Multivalued Attribute for any Entity
![image](/png/database/multi-attr.png)

#### Composite Attribute for any Entity
![image](/png/database/compose-attr.png)
...
![image](/png/database/db-transaction.png)
